 ...
 * @author misba zaidi
 */
public class targetSumUniqueTriplets {
    ...
    private static void threeSum(int[] arr, int n,int target) {
        ...
        for(int i=0;i<n-2;i++){
            ...
            int tar=target-val1;
             ...
             for(List<Integer> subRes:x){subRes.add(arr[i]);Collections.sort(subRes);System.out.println(subRes);}
        }
    }
